d3.json("https://eagledashboard-health.herokuapp.com/searchbyyear", function (data) {
    console.log(data.data);
});

d3.json('https://eagledashboard-health.herokuapp.com/searchbyyear', function (err, data) {
