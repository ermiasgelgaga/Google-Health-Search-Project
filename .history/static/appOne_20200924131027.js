function init() {
    ...
    console.log("init");
    d3.json('./searchbyyear').then(function (data) {

        console.log(data.data);

        var year = data.data.filter(function (rec) {
            return rec.type=="year"

        }).map(function (rec) {
            return rec.year
        })

        var searches = data.data.filter(function (rec) {
            return rec.type=="searches"
