...
function selectInit() {
    ...
    // Health Search Volume by Year DROPDOWN
    // Importing data from searchbyyear
    d3.json("/searchbyyear").then((importData) => {

        // Searching year through json
    ...
    d3.json("/searchyearandcondition").then((importData) => {
